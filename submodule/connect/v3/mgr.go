...
import (
	...
	"github.com/memoio/go-mefs-v2/submodule/connect/v3/impl"
	...
	v2inter "github.com/memoio/go-mefs-v2/submodule/connect/v2/interface"
)
...
func NewContractMgr(ctx context.Context, endPoint, baseAddr string, sk []byte) (*ContractMgr, error) {
	...
	eAddr, err := v2impl.SkToAddr(hexSk)
	if err != nil {
		return nil, err
	}

	val := v2.GetTxBalance(endPoint, eAddr)
	...
	erc20i, err := v2impl.NewErc20(endPoint, hexSk, erc20Addr)
	if err != nil {
		return nil, err
	}
